...
export class AccountClientFormPage {
    ...
    getClientDataByClientEname() {
        ...
        if (clientEname != undefined &&
            ...
            url_p = this.commonSvrc.url_dcube + "stellar/getClientDetailPrimByClientEname?clientename=" + clientEname;
        }
    ...
    getClientData() {
        ...
        if (clientId != undefined &&
            ...
            url_p = this.commonSvrc.url_dcube + "stellar/getClientDetailPrim?clientid=" + clientId;
        } else {
            if (clientEname != undefined &&
                clientEname != null &&
                clientEname.length > 10) {
