...
export const URL_LIVE_FEDERATION = 'http://dcubedev.com:8002/federation';
export const URL_TEST_FEDERATION = URL_LIVE_BRIDGE;
export const URL_DEV_FEDERATION = URL_LIVE_BRIDGE;
export const URL_DEMO_FEDERATION = URL_LIVE_BRIDGE;
